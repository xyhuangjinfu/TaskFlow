...
public class CompoundFuncBuilder2<P1, P2, R> extends CompoundFuncBuilderQ {

    public CompoundFuncBuilder2(IFunc2<P1, P2, ?> start) {
        super(start);
    }

    public CompoundFunc2<P1, P2, R> create() {
        IFunc[] startAndEnd = mGraphBuilder.getStartAndEnd();
        IFunc2<P1, P2, ?> start = (IFunc2<P1, P2, ?>) startAndEnd[0];
