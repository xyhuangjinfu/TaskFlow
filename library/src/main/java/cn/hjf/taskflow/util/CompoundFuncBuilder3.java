...
public class CompoundFuncBuilder3<P1, P2, P3, R> extends CompoundFuncBuilderQ {

    public CompoundFuncBuilder3(IFunc3<P1, P2, P3, ?> start) {
        super(start);
    }

    public CompoundFunc3<P1, P2, P3, R> create() {
        IFunc[] startAndEnd = mGraphBuilder.getStartAndEnd();
        IFunc3<P1, P2, P3, ?> start = (IFunc3<P1, P2, P3, ?>) startAndEnd[0];
